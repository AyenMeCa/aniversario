...
export const TIMELINE = [
  {
    ...
    pages: [
      ...
      "Tu novio te está esperando en algún lugar de la universidad... la verdad no recuerdo bien dónde. Pero en Los Hangares alguien sabe más que yo.",
    ],
    item: "Un Army Bomb",
  },
  {
    ...
    pages: [
      ...
      "Estos aretes te van a guiar hacia el próximo lugar... siento que hay una princesa esperándote en Mar Caribe.",
    ],
